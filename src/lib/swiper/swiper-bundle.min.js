...
!function (e, t) {
    ...
    function E(e = {}) {
        return b || (b = function ({userAgent: e} = {}) {
            ...
            const p = i.match(/(iPod)(.*OS\s([\d_]+))?/),
                u = !c && i.match(/(iPhone\sOS|iOS)\s([\d_]+)/), h = "Win32" === a;
            let m = "MacIntel" === a;
    ...
    const A = (e, t) => {
        const s = a(), {params: i, touchEvents: r, el: n, wrapperEl: l, device: o, support: d} = e,
            c = !!i.nested, p = "on" === t ? "addEventListener" : "removeEventListener", u = t;
        if (d.touch) {
        ...
        eventsEmitter: C, update: {
            ...
            slideTo: function (e = 0, t = this.params.speed, s = !0, a, i) {
                ...
                if (r.updateProgress(w), l.normalizeSlideIndex) for (let e = 0; e < d.length; e += 1) {
                    const t = -Math.floor(100 * w), s = Math.floor(100 * d[e]),
            ...
            setBreakpoint: function () {
                ...
                const o = (l in n ? n[l] : void 0) || e.originalParams, d = D(e, i), c = D(e, o),
                    p = i.enabled;
    ...
    const J = [function ({swiper: e, extendParams: t, on: s}) {
        ...
        function r(t) {
            const {
                ...
                slidesPerGroup: a,
                centeredSlides: r
            } = e.params, {addSlidesBefore: n, addSlidesAfter: l} = e.params.virtual, {
                from: o,
                to: d,
                slides: c,
                slidesGrid: p,
        ...
        function o(t) {
            ...
            const r = a.keyCode || a.charCode, o = e.params.keyboard.pageUpDown, d = o && 33 === r,
                c = o && 34 === r, p = 37 === r, u = 39 === r, h = 38 === r, m = 40 === r;
            ...
            if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || n.activeElement && n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase()))) {
                if (e.params.keyboard.onlyInViewport && (d || c || p || u || h || m)) {
                    ...
                    const a = e.$el, i = a[0].clientWidth, r = a[0].clientHeight, n = l.innerWidth,
                        o = l.innerHeight, d = e.$el.offset();
        ...
        function f() {
            ...
            const {scrollbar: t, rtlTranslate: s, progress: a} = e, {$dragEl: i, $el: r} = t,
        ...
        function b(t) {
            const s = e.params.scrollbar, {scrollbar: a, $wrapperEl: r} = e, {
                $el: l,
                $dragEl: o
            } = a;
        ...
        function l(t, s = !0) {
            ...
            !r.hasClass(i.elementClass) || r.hasClass(i.loadedClass) || r.hasClass(i.loadingClass) || n.push(r[0]), 0 !== n.length && n.each((t => {
                ...
                const o = n.attr("data-background"), c = n.attr("data-src"),
                    p = n.attr("data-srcset"), u = n.attr("data-sizes"), h = n.parent("picture");
        ...
        function o() {
            const {$wrapperEl: t, params: s, slides: a, activeIndex: i} = e,
                r = e.virtual && s.virtual.enabled, o = s.lazy;
            ...
            if (o.loadPrevNext) if (c > 1 || o.loadPrevNextAmount && o.loadPrevNextAmount > 1) {
                const e = o.loadPrevNextAmount, t = c,
        ...
        function c() {
            ...
            const s = e.params.lazy.scrollingElement ? d(e.params.lazy.scrollingElement) : d(t),
                a = s[0] === t, n = a ? t.innerWidth : s[0].offsetWidth,
                    ...
                    if (t < -e.minTranslate()) e.slideTo(e.activeIndex); else if (t > -e.maxTranslate()) e.slides.length < l.length ? e.slideTo(l.length - 1) : e.slideTo(e.slides.length - 1); else {
                        if (i.freeMode.momentum) {
                            if (o.velocities.length > 1) {
                                const t = o.velocities.pop(), s = o.velocities.pop(),
                                    a = t.position - s.position, r = t.time - s.time;
        ...
        t({cubeEffect: {slideShadows: !0, shadow: !0, shadowOffset: 20, shadowScale: .94}}), F({
            ...
            setTranslate: () => {
                const {
                        ...
                        size: l,
                        browser: o
                    } = e, c = e.params.cubeEffect, p = e.isHorizontal(),
        ...
        t({
            ...
            effect: "coverflow", swiper: e, on: s, setTranslate: () => {
                const {width: t, height: s, slides: a, slidesSizesGrid: i} = e,
                    r = e.params.coverflowEffect, n = e.isHorizontal(), l = e.translate,
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < t.length; r += 1) {
                    const n = t.eq(r), l = n[0].progress,
                        ...
                        c = [e.params.cssMode ? -d - e.translate : -d, 0, 0], p = [0, 0, 0];
                    let u = !1;
